import { Button, Flex, Icon, IconButton, Modal, ModalBody, ModalContent, ModalFooter, ModalHeader, ModalOverlay, Progress, Text, Tooltip, useDisclosure, useToast } from "@chakra-ui/react";
        ...
        <>
            <Flex flexDirection={"row"} alignItems={"center"}>
                ...
                <Tooltip hasArrow label="If music can't play, try click this.">
                    <IconButton flex={1} aria-label={"Play"} mr={2}
            ...
            <Modal isOpen={isOpen} onClose={onClose}>
                <ModalOverlay>
                    <ModalContent>
                        ...
                        <ModalBody>
                            <Text>
                                It seems that your browser didn't allow auto play. Please click the button below to enable auto play.
                            </Text>
                        </ModalBody>
                        <ModalFooter>
